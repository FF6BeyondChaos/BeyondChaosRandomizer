...
from bcg_junction import tblpath as jm_tblpath
from bcg_junction import write_patch as jm_write_patch
from character import get_characters
from randomtools.tablereader import set_patch_aliases as rt_set_patch_aliases
from randomtools.tablereader import verify_patches as rt_verify_patches
from utils import RANDOM_MULTIPLIER, Substitution, random

rt_set_patch_aliases('reference.65816.txt')
...
def imp_skimp(output_rom_buffer: BytesIO):
    jm_write_patch(output_rom_buffer, 'patch_imp_skimp_fix.txt')
...
def hidden_relic(output_rom_buffer: BytesIO, amount, feature_exclusion_list=None):
    ...
    if feature_exclusion_list:
        from itemrandomizer import STATPROTECT, get_items
