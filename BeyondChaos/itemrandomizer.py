...
invalid_commands = [0x00, 0x04, 0x11, 0x14, 0x15, 0x19, 0x1C, 0xFF]
...
def unhardcode_tintinabar(output_rom_buffer):
    ...
    tintinabar_sub.write(output_rom_buffer, patch_name='unhardcode_tintinabar')
