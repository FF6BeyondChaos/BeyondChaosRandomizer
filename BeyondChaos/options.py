...
NORMAL_FLAGS = [
    ...
    # Bug fix codes
    Flag(name='novanishdoom',
         description="DEATH IMMUNITY MODE",
         long_description="Prevents Vanish from removing Death immunity.",
         category="bug_fixes",
         inputtype="boolean"),
    Flag(name='stackingimmunities',
         description="IMMUNITY STACK MODE",
         long_description="",
         category="bug_fixes",
         inputtype="boolean"),
    Flag(name='wiccaphobia',
         description="MAGIC AVOIDANCE MODE",
         long_description="Magic evasion and magic block now function.",
         category="bug_fixes",
         inputtype="boolean"),
    Flag(name='returnfromxzone',
         description="XZONE REVIVAL MODE",
         long_description="Landing x-zone on an enemy with Life 3 will no longer make that enemy untargetable.",
         category="bug_fixes",
         inputtype="boolean"),
    Flag(name='impskimp',
         description="IMP SKIMP MODE",
         long_description="The imp sprite will now be shown for enemies "
                          "that have imp status from sources other than the"
                          "imp spell.",
         category="bug_fixes",
         inputtype="boolean"),
    Flag(name='infrequentflier',
         description="GROUNDED NPCS MODE",
         long_description="The NPCs in certain cutscenes will no longer fly off screen, leaving the player softlocked.",
         category="bug_fixes",
         inputtype="boolean"),
    Flag(name='deathabuse',
         description="DEATH ABUSE MODE",
         long_description="",
         category="bug_fixes",
         inputtype="boolean"),
    Flag(name='friendsforever',
         description="DOG KEEPER MODE",
         long_description="Prevents Shadow from losing Interceptor status.",
         category="bug_fixes",
         inputtype="boolean"),
    Flag(name='gogoportrait',
         description="GOGO PORTRAIT MODE",
         long_description="Fixes an issue with the display of Gogo's portrait.",
         category="bug_fixes",
         inputtype="boolean"),
    Flag(name='banonlives',
         description="BANON RESURRECTION MODE",
         long_description="Banon dying with Life 3 will no long cause a game over.",
         category="bug_fixes",
         inputtype="boolean"),
    ...
    Flag(name='tastetherainbow',
         ...
         inputtype="boolean"),
    Flag(name='improvedpartygear',
         description="BETTER EQUIP SCREEN MODE",
         long_description="",
         category="quality_of_life",
         inputtype="boolean"),
...
Flag(name='slowerbg',
    ...
    Flag(name='levelcap',
         ...
         long_description="The max level a character can reach is changed to the specified value. (0 for random max)",
         category="characters",
         inputtype="integer",
         default_value="99",
         minimum_value=0,
