...
NORMAL_CODES = [
    ...
    Code('exp', "3 Times Exp", "All battles will award 3 times exp", "beta", "numberbox"),
    Code('gp', "3 Times gp", "All battles will award 3 times gp", "beta", "numberbox"),
    Code('mps', "3 Times magic points", "All battles will award 3 times magic points. Does not do anything?", "beta", "numberbox"),
