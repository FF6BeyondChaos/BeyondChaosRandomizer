...
NORMAL_FLAGS = [
    ...
    Flag(name='levelcap',
         ...
         long_description="The max level a character can reach is changed to the specified value. Random is a global random level cap, Chaos is individual random level caps",
         category="characters",
         inputtype="combobox",
